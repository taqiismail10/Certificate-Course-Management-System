...
const AdminDashboard: React.FC = () => {
  ...
  const assignTeachers = (selectedTeachers: string[]) => {
    if (selectedCourse) {
      ...
      setUnassignedCourses(
        unassignedCourses.filter((course) => course.courseid !== selectedCourse.courseid)
      );
      setPopupOpen(false);
    }
  };
                    ...
                    >
                      ...
                      <div>
                        ...
                        <button
                          ...
                          onClick={() => handleDelete(course.courseid, isAssigned)}
                        >
                          Delete
                        </button>
                      </div>
...

  {
    showPopup && (
      <div className="popup">
        {/* Popup content */}
        <TeacherList teacherfirstname={teacherfirstname}> </TeacherList>
        <h2>Popup Title</h2>
